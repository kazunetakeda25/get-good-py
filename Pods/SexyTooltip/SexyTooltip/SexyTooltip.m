                     ...
                     andMargin:(UIEdgeInsets)margin
{
    ...
    if (self) {
        ...
        [label sizeToFit];
        [label setBackgroundColor:[UIColor colorWithRed:0.56f green:0.77f blue:0.24f alpha:1.0f]];
        [label setTextColor:[UIColor whiteColor]];
        self.contentView = label;
        [self.contentView setBackgroundColor:[UIColor colorWithRed:0.56f green:0.77f blue:0.24f alpha:1.0f]];
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _color = [UIColor colorWithRed:0.56f green:0.77f blue:0.24f alpha:1.0f];
